...
export default function CollectionFrames() {
  ...
  const images = ['442', '501', '134', '105', '43', '86'];
          ...
          <div className={`${styles.embla__slide} ${styles.card_first}`}>
            <div>
              <span className="embla-no-drag">
                <div className={styles.title}>Frames</div>
              </span>
              <div className={styles.text_secondary}>
                <Trans>Ethereum - December 2025</Trans>
              </div>
              <div className={styles.text_secondary}>
            ...
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              href={collectionsData['frames'].marketplaces.rarible.link}
            >
              Rarible &gt;
            </Link>
          </div>
